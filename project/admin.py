...
class ProjectAdmin(admin.ModelAdmin):
    list_display = ['flow_id', 'name', 'all_role', 'course', 'reference', 'public_status', 'level', 'entire_graph', 'type', 'can_redo', 'is_open', 'ability_target', 'start_time', 'end_time', 'intro', 'purpose', 'requirement', 'created_by', 'create_time', 'update_time', 'del_flag']
    # list_filter = []  # 过滤字段
