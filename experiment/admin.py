...
class ExperimentAdmin(admin.ModelAdmin):
    list_display = ['name', 'huanxin_id', 'project_id', 'show_nickname', 'start_time', 'end_time', 'team_id', 'status', 'created_by', 'course_class_id', 'node_id',  'create_time', 'update_time', 'del_flag']
    # list_filter = []  # 过滤字段
...
# 消息
class ExperimentMessageAdmin(admin.ModelAdmin):
    list_display = ['experiment_id', 'msg', 'msg_type', 'ext', 'timestamp']
    # list_filter = []  # 过滤字段
    # list_editable = []  # 列表编辑字段
    # readonly_fields = []  # 只读字段
...
admin.site.register(ExperimentMessage, ExperimentMessageAdmin)


# 评价样本类型
class EvaluateTypeAdmin(admin.ModelAdmin):
    list_display = ['label']
    # list_filter = []  # 过滤字段
    # list_editable = []  # 列表编辑字段
    # readonly_fields = []  # 只读字段
...
admin.site.register(EvaluateType, EvaluateTypeAdmin)


# 评价样本
class EvaluatePoolAdmin(admin.ModelAdmin):
    list_display = ['evaluate_type', 'evaluate_level', 'evaluate_content']
    list_filter = ['evaluate_type', 'evaluate_level']  # 过滤字段
    # list_editable = []  # 列表编辑字段
    # readonly_fields = []  # 只读字段
...
admin.site.register(EvaluatePool, EvaluatePoolAdmin)
